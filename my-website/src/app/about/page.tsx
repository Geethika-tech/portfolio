...
export default function AboutMe(){
    ...
    <>
      <div className="max-w-7xl mt-10 mx-auto p-6 flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-2/3 flex flex-col bg-white p-8 rounded-3xl shadow-xl space-y-8">
          ...
          <p className="text-gray-700 text-justify leading-relaxed tracking-wide hyphens-auto">
            ...
            Next.js, Typescript, Node.js. I have developed and optimized REST APIs,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div className="bg-purple-50 p-6 rounded-2xl shadow hover:shadow-purple-200 transition duration-300">
              <h5 className="font-semibold text-purple-600 mb-3 text-lg">
                Web Development
              </h5>
              <p className="text-gray-700 text-justify leading-relaxed tracking-wide hyphens-auto">
                ...
                real-world problems. From designing interactive dashboards to
                integrating backend APIs, I focus on delivering seamless experiences
                while keeping code scalable and maintainable.
              </p>
            </div>

            {/* Mentorship */}
            <div className="bg-orange-50 p-6 rounded-2xl shadow hover:shadow-orange-200 transition duration-300">
              <h5 className="font-semibold text-orange-600 mb-3 text-lg">
                Mentorship
              </h5>
              <p className="text-gray-700 text-justify leading-relaxed tracking-wide hyphens-auto">
